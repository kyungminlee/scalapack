...
*          The first term covers PDPORFS, the second covers PDPOCON; the
*          PDLANSY('1') norm requirement of 2*NQ + NP + LDW is dominated.
*
...
*
     ...
     $         NP = NP-IROFFA
            ...
            IF( MYCOL.EQ.IACOL )
     $         NQ = NQ-ICOFFA
*           LWMIN sized to satisfy both PDPOCON and PDPORFS workspace
*           requirements (cf. PDGESVX).
            LWMIN = MAX( 3*NP,
     $              2*NP + 2*NQ +
     $              MAX( 2, MAX( DESCA( NB_ )*
